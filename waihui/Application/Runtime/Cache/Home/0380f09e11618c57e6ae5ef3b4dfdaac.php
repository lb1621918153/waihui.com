...
<div class="main_box">
    ...
    <div class="left_side me userleft">
        <ul>
            ...
            <li class="active2"><a href="/index.php/Home/User">个人中心<i class="icon_right"></i></a></li>
            <li><a href="userpay.html">充值<i class="icon_right"></i></a></li>
            <li><a href="javascript:void(0)" onclick="txgourl()">提现<i class="icon_right"></i></a></li>
            <li><a href="/index/user/zxkf.html">留言板<i class="icon_right"></i></a></li>
            <li><a href="index.html" target="_blank">关于我们<i class="icon_right"></i></a></li>
            <li><a href="/index/user/editinfo.html">修改信息<i class="icon_right"></i></a></li>
            <li><a href="javascript:;" onclick="app_exit()">退出<i class="icon_right"></i></a></li>
        </ul>
    </div>
    <script>
        function txgourl() {
            var is_smrz = "0";
            var successurl = "/index/user/outmoney.html";
            if (is_smrz == 2) {
                location.href = successurl;
            } else if (is_smrz == 0) {
                layer.msg("您还未提交实名认证，不可以提现！");
            } else if (is_smrz == 1) {
                layer.msg("实名认证审核中，请等待通过后再提现！");
            } else {
                layer.msg("实名认证未通过，请修改认证后再提现！");
            }
        }
    </script>
    <!-- 中间主体 -->
