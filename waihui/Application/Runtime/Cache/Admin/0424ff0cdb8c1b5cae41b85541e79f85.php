                ...
                <div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form id="form" action="/Admin/Calendar/update" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10 form-inline">
                                    ...
                                    <input id="area" type="text" name="area" value="<?php echo ($calendar["area"]); ?>" class="form-control" size="67">
                                    ...
                                    <br><br>
                                    <img id="preview" src="/Public<?php echo ($calendar["area"]); ?>" alt="地区图片" width="100">
                                </div>
                            </div>
                            <div class="row row-height">
                                <div class="col-sm-2 text-right">日期：</div>
                                <div class="col-sm-10 form-inline"><input name="date" class="form-control" type="date" value="<?php echo ($calendar["date"]); ?>"></div>
                            </div>
                            <div class="row row-height">
                                <div class="col-sm-2 text-right">时间：</div>
                                <div class="col-sm-10 form-inline"><input name="time" class="form-control" type="time" value="<?php echo ($calendar["time"]); ?>"></div>
                            </div>
                            <div class="row row-height">
                                <div class="col-sm-2 text-right">指标名称：</div>
                                <div class="col-sm-10 form-inline"><textarea name="name" class="form-control"
                                                                             cols="70"><?php echo ($calendar["name"]); ?></textarea></div>
                            </div>
                            <div class="row row-height">
                                <div class="col-sm-2 text-right">前值：</div>
                                <div class="col-sm-10 form-inline"><input name="before_value" class="form-control" type="number" value="<?php echo ($calendar["before_value"]); ?>"></div>
                            </div>
                            <div class="row row-height">
                                <div class="col-sm-2 text-right">预期：</div>
                                <div class="col-sm-10 form-inline">
                                    <input name="expected" class="form-control" type="number" value="<?php echo ($calendar["expected"]); ?>">
                                </div>
                            </div>
                            <div class="row row-height">
                                <div class="col-sm-2 text-right">公布：</div>
                                <div class="col-sm-10 form-inline">
                                    <input name="announce" class="form-control" type="number" value="<?php echo ($calendar["announce"]); ?>">
                                </div>
                            </div>
                            <div class="row row-height">
                                <div class="col-sm-2 text-right">影响：</div>
                                <div class="col-sm-10 form-inline"><input name="effect" class="form-control" type="text" value="<?php echo ($calendar["effect"]); ?>"></div>
                            </div>
                            <div class="row row-height">
...
<script>
    const SCOPE = {
        ...
        deleteDataUrl: '/Admin/Calendar/del',
        showDataUrl: '/Admin/Calendar/detail',
