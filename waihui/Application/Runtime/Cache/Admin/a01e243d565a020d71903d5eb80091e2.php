                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <?php if(is_array($withdrawals)): $i = 0; $__LIST__ = $withdrawals;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$withdrawal): $mod = ($i % 2 );++$i;?><tr class="user-table-font-size">
                                    ...
                                    <td>
                                        <button <?php if($withdrawal["status"] != 0): ?>disabled<?php endif; ?> type="button" class="btn btn-danger" data-id="<?php echo ($withdrawal["withdrawal_id"]); ?>" data-toggle="modal" data-target="#writeIntro" title="拒绝提现请求，需填写拒绝信息" onclick="refuse(this)">
                                            拒绝
                                        </button>
                                        <button <?php if($withdrawal["status"] != 0): ?>disabled<?php endif; ?> type="button" class="btn btn-primary" data-id="<?php echo ($withdrawal["withdrawal_id"]); ?>" title="请先查看该用户的详情，点击提现后再转账" onclick="withdrawal(this)">
                                            提现
                                        </button>
                                    </td>
...
<script>
    const SCOPE = {
        ...
        deleteDataUrl: '/Admin/Withdrawal/del',
        showDataUrl: '/Admin/Withdrawal/detail',
        refuseRechargeUrl: '/Admin/Withdrawal/refuse',
        withdrawalUrl: '/Admin/Withdrawal/withdrawal',
    };
