                ...
                <div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="panel-title">财经日历信息表</h3>
                                </div>
                                <div class="col-sm-6 text-right">
                                    <a href="/Admin/Calendar/Add" class="btn btn-primary">添加财经日历</a>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <?php if(is_array($calendars)): $i = 0; $__LIST__ = $calendars;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$calendar): $mod = ($i % 2 );++$i;?><tr class="text-center">
                                    <td><img src="/Public<?php echo ($calendar["area"]); ?>" alt="地区图片" width="40"></td>
                                    <td><?php echo ($calendar["date"]); ?></td>
                                    <td><?php echo ($calendar["time"]); ?></td>
                                    <td title="<?php echo ($calendar["name"]); ?>"><?php echo (showLimitMsg($calendar["name"])); ?></td>
                                    ...
                                    <td><?php echo ($calendar["effect"]); ?></td>
                                    <td>
                                        <button type="button" class="btn btn-danger" data-id="<?php echo ($calendar["id"]); ?>" onclick="delData(this)">
                                            删除
                                        </button>
                                        <button type="button" class="btn btn-primary" data-id="<?php echo ($calendar["id"]); ?>" onclick="showData(this)">
                                            编辑
                                        </button>
                                    </td>
