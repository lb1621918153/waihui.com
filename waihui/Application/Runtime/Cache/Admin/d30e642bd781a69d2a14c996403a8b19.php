    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <li><a href="/index.php/Admin/Order"
        ...
        <div class="main-content">
            <div class="container-fluid">
                ...
                <div>
                    <!-- BORDERED TABLE -->
                    <div class="panel">
                        <form action="/index.php/Admin/News/doadd" method="post">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-sm-7">
                                        <h3 class="panel-title">财经新闻添加</h3>
                                    </div>
                            ...
                            <div class="panel-body">
                                <div class="row row-height">
                                    ...
                                    <div class="col-sm-10 form-inline">
                                        <input name="news_title" class="form-control" type="text" size="48">
                                ...
                                <div class="row row-height">
                                    ...
                                    <div class="col-sm-10 form-inline">
                                        ...
                                        <input id="newsThum" name="news_thum" class="form-control" type="text" size="48">
                                        ...
                                        <br>
                                        <img id="preview" src="" alt="缩略图片预览" width="100">
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <br>
                                <script id="container" name="news_content" class="height" type="text/plain"></script>
                            </div>
                            <br><br><br><br>
                        </form>
                    </div>
...
<script>
    const SCOPE = {
        ...
        deleteDataUrl: '/index.php/Admin/News/del',
        showDataUrl: '/index.php/Admin/News/detail',
        imageUploadUrl: '/index.php/Admin/image/newsUpload'
    };
