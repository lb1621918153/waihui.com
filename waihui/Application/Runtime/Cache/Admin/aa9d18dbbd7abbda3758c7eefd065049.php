    ...
    <div class="container-fluid">
        ...
        <div id="navbar-menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#"><i class="lnr lnr-question-circle"></i> <span>帮助</span></a>
                </li>
                <li class="dropdown">
        ...
        <nav>
            <ul class="nav">
                <li><a href="/index.php/Admin/index"
                    <?php if(CONTROLLER_NAME == 'Index'): ?>class="active"<?php endif; ?>><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
...
<script>
    const SCOPE = {
        ...
        deleteDataUrl: '/index.php/Admin/Calendar/del',
        showDataUrl: '/index.php/Admin/Calendar/detail',
