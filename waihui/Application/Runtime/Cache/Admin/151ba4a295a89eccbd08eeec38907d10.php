...
<div id="wrapper">
    ...
    <div class="brand">
        <a href="/index.php/Admin"><img src="/Public/admin/img/logo-dark.png" alt="WaiHui Logo" class="img-responsive logo"></a>
    </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/index.php/Admin/login/logout"><i class="lnr lnr-exit"></i> <span>注销</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
                ...
                <div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">产品信息添加</h3>
                        </div>
                        <div class="panel-body">
                            <form id="form" action="" method="post">
                                <div class="row row-height">
                                    <div class="col-sm-2 text-right">产品名称：</div>
                                    <div class="col-sm-10 form-inline"><input name="product_name" class="form-control" type="text"></div>
                                </div>
                                <div class="row row-height">
                                    <div class="col-sm-2 text-right">当前值：</div>
                                    <div class="col-sm-10 form-inline"><input name="current" class="form-control" type="text"></div>
                                </div>
                                <div class="row row-height">
                                    <div class="col-sm-2 text-right">最低值：</div>
                                    <div class="col-sm-10 form-inline"><input name="lowest" class="form-control" type="text"></div>
                                </div>
                                <div class="row row-height">
                                    <div class="col-sm-2 text-right">最高值：</div>
                                    <div class="col-sm-10 form-inline"><input name="highest" class="form-control" type="text"></div>
                                </div>
                                <div class="row row-height">
                                    <div class="col-sm-2 text-right">开盘：</div>
                                    <div class="col-sm-10 form-inline"><input name="open" class="form-control" type="text"></div>
                                </div>
                                <div class="row row-height">
                                    <div class="col-sm-2 text-right">昨收：</div>
                                    <div class="col-sm-10 form-inline"><input name="income" class="form-control" type="text"></div>
                                </div>
                                <div class="row row-height">
                                    <div class="col-sm-2 text-right">手续费：</div>
                                    <div class="col-sm-10 form-inline form-group">
                                        <div class="input-group">
                                            <input name="handing_fee" type="text" class="form-control" id="handle" aria-describedby="handle" size="14">
...
<script>
    const SCOPE = {
        updatePwdUrl: '/index.php/Admin/admin/update',
        deleteDataUrl: '/index.php/Admin/Product/del',
        showDataUrl: '/index.php/Admin/Product/detail',
        imageUploadUrl: '/index.php/Admin/image/upload'
    };
