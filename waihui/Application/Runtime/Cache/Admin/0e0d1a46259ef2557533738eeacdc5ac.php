                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <?php if(is_array($recharges)): $i = 0; $__LIST__ = $recharges;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$recharge): $mod = ($i % 2 );++$i;?><tr class="user-table-font-size">
                                    ...
                                    <td>
                                        <button <?php if($recharge["status"] != 0): ?>disabled<?php endif; ?> type="button" class="btn btn-danger" data-id="<?php echo ($recharge["recharge_id"]); ?>" data-toggle="modal" data-target="#writeIntro" title="拒绝提现请求，需填写拒绝信息" onclick="refuse(this)">
                                            拒绝
                                        </button>
                                        <button <?php if($recharge["status"] != 0): ?>disabled<?php endif; ?> type="button" class="btn btn-primary" data-id="<?php echo ($recharge["recharge_id"]); ?>" title="确认提现" onclick="recharge(this)">
                                            确认
                                        </button>
                                    </td>
...
<script>
    const SCOPE = {
        ...
        deleteDataUrl: '/Admin/Recharge/del',
        showDataUrl: '/Admin/Recharge/detail',
        refuseRechargeUrl: '/Admin/Recharge/refuse',
        rechargeUrl: '/Admin/Recharge/recharge',
    };
